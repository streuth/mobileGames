var sprites = {
    ...
    enemy_circle: {sx: 158, sy: 0, w: 32, h: 43, frames: 1 }
};
...
var startGame = function () {
    ...
    Game.setBoard(1, new Starfield(25, 0.6, 100))
...
var Enemy = function(blueprint, override) {
    ...
    //Copy of all the attribute4s from the blueprint
    for (var prop in blueprint) {
        this[prop] = blueprint[prop];
    }
    //Copy of all the attribtues from the override, if present
    if (override) {
